...
import io.github.tanice.twItemManager.manager.player.PlayerAttributeManager;
...
public final class TwItemManager extends JavaPlugin {
    ...
    @Getter
    private static PlayerAttributeManager playerAttributeManager;
    ...
    private static PlayerAttributeListener playerAttributeListener;
    ...
    public void onEnable() {
        ...
        playerAttributeManager = new PlayerAttributeManager();
        ...
        playerAttributeListener = new PlayerAttributeListener(this);
    ...
    public void onDisable() {
        ...
        if (playerAttributeManager != null) playerAttributeManager.onDisable();
    ...
    public void onReload() {
        ...
        playerAttributeManager.onReload();
